...
<span className="section-eyebrow gold-text">ACCREDITED BOUTIQUE HOSPITALITY</span>
...
<div className="filter-tabs" id="hotel-filters" role="tablist" style={{'justifyContent': 'center'}}>
...
<img alt="Mayfair Tea Resort &amp; Spa" height="220" loading="lazy" src="https://images.unsplash.com/photo-1566073771259-6a8506099945?q=80&amp;w=800&amp;auto=format&amp;fit=crop" width="400"/>
</div>
...
<span className="hotel-price-val blurred-price">₹14,500 <small>/ night</small></span>
<span className="revealing-soon-badge">Revealing Soon</span>
</div>
</div>
<a className="btn btn-sm btn-outline-gold" href="contact.html?subject=Hotel+Booking+Mayfair+Tea+Resort">
...
<img alt="Ri Kynjai Lake Resort" height="220" loading="lazy" src="https://images.unsplash.com/photo-1542314831-068cd1dbfeeb?q=80&amp;w=800&amp;auto=format&amp;fit=crop" width="400"/>
</div>
<div className="hotel-body">
<div className="hotel-location">
<svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24">
...
<h3 className="hotel-title">Ri Kynjai – Serenity by the Lake</h3>
<p className="hotel-desc">
...
<span className="hotel-price-label">Starting Rate</span>
<div className="price-reveal-wrap">
<span className="hotel-price-val blurred-price">₹12,800 <small>/ night</small></span>
<span className="revealing-soon-badge">Revealing Soon</span>
</div>
</div>
<a className="btn btn-sm btn-outline-gold" href="contact.html?subject=Hotel+Booking+Ri+Kynjai">
<span>Reserve Stay</span>
<span className="btn-arrow">→</span>
</a>
</div>
...
<img alt="The Elgin Nor-Khill Gangtok" height="220" loading="lazy" src="https://images.unsplash.com/photo-1582719508461-905c673771fd?q=80&amp;w=800&amp;auto=format&amp;fit=crop" width="400"/>
</div>
<div className="hotel-body">
<div className="hotel-location">
<svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24">
...
<h3 className="hotel-title">The Elgin Nor-Khill Heritage Villa</h3>
<p className="hotel-desc">
...
<span className="hotel-price-label">Starting Rate</span>
<div className="price-reveal-wrap">
<span className="hotel-price-val blurred-price">₹16,200 <small>/ night</small></span>
<span className="revealing-soon-badge">Revealing Soon</span>
</div>
</div>
<a className="btn btn-sm btn-outline-gold" href="contact.html?subject=Hotel+Booking+Elgin+NorKhill">
<span>Reserve Stay</span>
<span className="btn-arrow">→</span>
</a>
</div>
...
<img alt="Polo Orchid Cliff Haven" height="220" loading="lazy" src="https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?q=80&amp;w=800&amp;auto=format&amp;fit=crop" width="400"/>
</div>
<div className="hotel-body">
<div className="hotel-location">
<svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24">
...
<span className="hotel-price-label">Starting Rate</span>
<div className="price-reveal-wrap">
<span className="hotel-price-val blurred-price">₹15,000 <small>/ night</small></span>
<span className="revealing-soon-badge">Revealing Soon</span>
</div>
</div>
<a className="btn btn-sm btn-outline-gold" href="contact.html?subject=Hotel+Booking+Polo+Orchid">
<span>Reserve Stay</span>
<span className="btn-arrow">→</span>
</a>
</div>
...
<img alt="Vivanta Meghalaya Shillong" height="220" loading="lazy" src="https://images.unsplash.com/photo-1571896349842-33c89424de2d?q=80&amp;w=800&amp;auto=format&amp;fit=crop" width="400"/>
</div>
<div className="hotel-body">
<div className="hotel-location">
<svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24">
...
<span className="hotel-price-label">Starting Rate</span>
<div className="price-reveal-wrap">
<span className="hotel-price-val blurred-price">₹13,500 <small>/ night</small></span>
<span className="revealing-soon-badge">Revealing Soon</span>
</div>
</div>
<a className="btn btn-sm btn-outline-gold" href="contact.html?subject=Hotel+Booking+Vivanta+Shillong">
<span>Reserve Stay</span>
<span className="btn-arrow">→</span>
</a>
</div>
...
<img alt="Denzong Regency Mountain Resort" height="220" loading="lazy" src="https://images.unsplash.com/photo-1584132967334-10e028bd69f7?q=80&amp;w=800&amp;auto=format&amp;fit=crop" width="400"/>
</div>
<div className="hotel-body">
<div className="hotel-location">
<svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24">
...
<span className="hotel-price-label">Starting Rate</span>
<div className="price-reveal-wrap">
<span className="hotel-price-val blurred-price">₹14,000 <small>/ night</small></span>
<span className="revealing-soon-badge">Revealing Soon</span>
</div>
</div>
<a className="btn btn-sm btn-outline-gold" href="contact.html?subject=Hotel+Booking+Denzong+Regency">
<span>Reserve Stay</span>
<span className="btn-arrow">→</span>
</a>
</div>
...
<img alt="Heritage Club Tripura Castle" height="220" loading="lazy" src="https://images.unsplash.com/photo-1566073771259-6a8506099945?q=80&amp;w=800&amp;auto=format&amp;fit=crop" width="400"/>
</div>
<div className="hotel-body">
<div className="hotel-location">
<svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24">
...
<div className="hotel-amenities">
<span className="hotel-amenity-chip">Historic Royal Palace</span>
...
<span className="hotel-price-label">Starting Rate</span>
<div className="price-reveal-wrap">
<span className="hotel-price-val blurred-price">₹11,500 <small>/ night</small></span>
<span className="revealing-soon-badge">Revealing Soon</span>
</div>
</div>
<a className="btn btn-sm btn-outline-gold" href="contact.html?subject=Hotel+Booking+Tripura+Castle">
<span>Reserve Stay</span>
<span className="btn-arrow">→</span>
</a>
</div>
...
<div className="hotel-card" data-category="luxury">
<div className="hotel-image-wrapper">
<span className="hotel-badge">Executive Palace View</span>
<span className="hotel-rating-badge">
<svg viewBox="0 0 24 24">
<polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon>
</svg>
...
<img alt="Ginger Agartala Executive Suites" height="220" loading="lazy" src="https://images.unsplash.com/photo-1590490360182-c33d57733427?q=80&amp;w=800&amp;auto=format&amp;fit=crop" width="400"/>
</div>
<div className="hotel-body">
<div className="hotel-location">
<svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24">
...
<h3 className="hotel-title">Ginger Agartala &amp; Executive Suites</h3>
<p className="hotel-desc">
                  The preferred premium stay in Tripura's capital. Conveniently
                  located minutes from Ujjayanta Palace and MBB Airport with
                  modern culinary services and conference facilities.
                </p>
<div className="hotel-amenities">
<span className="hotel-amenity-chip">Airport Transfer</span>
<span className="hotel-amenity-chip">Multi-Cuisine Cafe</span>
<span className="hotel-amenity-chip">Fitness Centre</span>
<span className="hotel-amenity-chip">High-Speed WiFi</span>
</div>
<div className="hotel-footer">
<div className="hotel-price">
<span className="hotel-price-label">Starting Rate</span>
<div className="price-reveal-wrap">
<span className="hotel-price-val blurred-price">₹6,800 <small>/ night</small></span>
<span className="revealing-soon-badge">Revealing Soon</span>
</div>
</div>
<a className="btn btn-sm btn-outline-gold" href="contact.html?subject=Hotel+Booking+Ginger+Agartala">
<span>Reserve Stay</span>
<span className="btn-arrow">→</span>
</a>
</div>
...
<span className="section-eyebrow gold-text">BESPOKE CONCIERGE PRIVILEGES</span>
<h2 className="section-heading" style={{'margin': '0.5rem auto 1rem', 'maxWidth': '700px'}}>
              Need Direct Contracting or Group Villa Booking?
            </h2>
<p className="section-desc" style={{'maxWidth': '620px', 'margin': '0 auto 2rem'}}>
...
<a className="btn btn-outline-glass btn-large" href="https://wa.me/918731010676?text=Hello%20Global%20Holidays,%20I%20am%20interested%20in%20booking%20luxury%20hotels." rel="noopener" target="_blank">
