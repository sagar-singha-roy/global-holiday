...
<span className="section-eyebrow gold-text">PERSONAL TRAVEL CONCIERGE</span>
...
<p className="section-desc" style={{'margin': '0 auto 2.5rem', 'maxWidth': '740px'}}>
 ...
 Interactive Custom Trip Planner Widget 
<section className="section" id="planner" style={{'paddingTop': '1rem', 'paddingBottom': '4rem'}}>
<div className="container">
<div className="planner-card glass-panel">
<div className="planner-header text-center">
<span className="section-eyebrow gold-text">STEP-BY-STEP CUSTOM PLANNER</span>
...
<form className="planner-form" id="trip-planner-form" onsubmit="return false;">

<div className="planner-step-group">
<label className="step-label"><span className="step-num">1</span> Select Travel Style</label>
<div className="vibe-selectors" id="vibe-selector-group">
<button className="vibe-btn active" data-vibe="Honeymoon" type="button">
...
<button className="vibe-btn" data-vibe="Friends" type="button">
<span className="vibe-icon">
<svg fill="none" height="22" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="22">
<path d="M8 22h8"></path>
...
<button className="vibe-btn" data-vibe="Adventure" type="button">
<span className="vibe-icon">
<svg fill="none" height="22" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="22">
...
<button className="vibe-btn" data-vibe="Corporate" type="button">
<span className="vibe-icon">
<svg fill="none" height="22" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="22">
...
<div className="planner-step-group">
<label className="step-label"><span className="step-num">2</span> Journey Parameters</label>
<div className="planner-inputs-grid">
<div className="form-field">
<label htmlFor="plan-destination">Desired Destination</label>
...
<option value="Himachal &amp; Spiti">Himachal &amp; Spiti</option>
...
<input id="plan-date" min="2026-08-22" required="" type="date"/>
</div>
<div className="form-field">
...
<div className="planner-step-group">
<label className="step-label"><span className="step-num">3</span> Your Contact Info</label>
<div className="planner-inputs-grid-3">
<div className="form-field">
<label htmlFor="plan-name">Your Full Name</label>
<input id="plan-name" placeholder="e.g. Debabrata Roy" required="" type="text"/>
</div>
<div className="form-field">
<label htmlFor="plan-phone">Phone / WhatsApp Number</label>
<input id="plan-phone" placeholder="e.g. +91 87310 10676" required="" type="tel"/>
</div>
<div className="form-field">
<label htmlFor="plan-email">Email Address</label>
<input id="plan-email" placeholder="e.g. name@example.com" required="" type="email"/>
</div>
</div>
</div>
...
<span>Trip Vibe:
                    <strong id="summary-vibe">Honeymoon</strong></span>
<span>•</span>
<span>Destination:
                    <strong id="summary-dest">Select above</strong></span>
</div>
<div className="planner-btn-duo">
<button className="btn btn-gold btn-large" id="submit-custom-plan-btn" type="submit">
<span>Submit Inquiry</span>
<svg className="btn-arrow" fill="none" height="18" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" width="18">
<path d="M5 12h14M12 5l7 7-7 7"></path>
</svg>
</button>
<button className="btn btn-outline-glass btn-large" id="whatsapp-plan-btn" type="button">
...
<section className="section" id="contact-info" style={{'background': 'var(--bg-surface)'}}>
<div className="container">
<div className="contact-grid">

<div className="contact-info-col">
<span className="section-eyebrow gold-text">AGARTALA CONCIERGE DESK</span>
...
<a className="contact-method-card glass-panel" href="tel:+918731010676">
...
<strong className="cm-value">+91 87310 10676 / +91 88370 70817</strong>
<span className="cm-note">Mon – Sat, 9:30 AM to 8:30 PM IST</span>
</div>
</a>
<a className="contact-method-card glass-panel wa-card" href="https://wa.me/918731010676" rel="noopener" target="_blank">
...
<span className="cm-note">Immediate response from travel designers</span>
</div>
</a>
<a className="contact-method-card glass-panel" href="mailto:globalholidaysagt@gmail.com">
<div className="cm-icon">
<svg fill="none" height="22" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" width="22">
...
<strong className="cm-value">globalholidaysagt@gmail.com</strong>
<span className="cm-note">For comprehensive customized proposals</span>
</div>
</a>
...
<strong className="cm-value">near hornbill restaurant, Banerjee Para, Krishna Nagar, Agartala, Tripura -
                      799003</strong>
<span className="cm-note">In-person itinerary discussion over tea &amp; coffee</span>
</div>
</div>
</div>
</div>
...
<input id="contact-name" name="name" placeholder="Debabrata Roy" required="" type="text"/>
</div>
<div className="form-field">
<label htmlFor="contact-phone">Phone / WhatsApp *</label>
<input id="contact-phone" name="phone" placeholder="+91 87310 10676" required="" type="tel"/>
</div>
</div>
<div className="form-row">
<div className="form-field">
<label htmlFor="contact-email">Email Address *</label>
<input id="contact-email" name="email" placeholder="debabrata@example.com" required="" type="email"/>
</div>
<div className="form-field">
<label htmlFor="contact-dest">Preferred Destination *</label>
<input id="contact-dest" name="destination" placeholder="e.g. Meghalaya / Kashmir / Sikkim" required="" type="text"/>
</div>
</div>
<div className="form-row">
<div className="form-field">
<label htmlFor="contact-date">Travel Month / Date</label>
<input id="contact-date" min="2026-08-22" name="travel_date" type="date"/>
</div>
<div className="form-field">
<label htmlFor="contact-travelers">Number of Travellers</label>
<input id="contact-travelers" max="50" min="1" name="travelers" placeholder="2" type="number"/>
</div>
</div>
<div className="form-field">
<label htmlFor="contact-msg">Special Requests / Preferences</label>
<textarea id="contact-msg" name="message" placeholder="Tell us about preferred stays, activities, dietary preferences, or specific places you want to visit..." rows="3"></textarea>
</div>
<button className="btn btn-gold btn-large w-100" id="send-enquiry-btn" type="submit">
...
<span className="section-eyebrow gold-text">HELP &amp; CLARITY</span>
<h2 className="section-heading">Frequently Asked Questions</h2>
<p className="section-desc" style={{'margin': '0.5rem auto 0', 'maxWidth': '680px'}}>
...
<span className="faq-question-text">How can I book a package?</span>
</div>
...
<span className="faq-question-text">Can you customize packages?</span>
</div>
<div aria-hidden="true" className="faq-icon-toggle">
<svg fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" viewBox="0 0 24 24" width="18">
<polyline points="6 9 12 15 18 9"></polyline>
...
<div className="faq-answer">
<p>
<strong>Yes, 100% of our tour packages are fully
                    customizable.</strong>
...
<span className="faq-question-text">Do you provide transportation?</span>
</div>
<div aria-hidden="true" className="faq-icon-toggle">
<svg fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" viewBox="0 0 24 24" width="18">
<polyline points="6 9 12 15 18 9"></polyline>
...
<div className="faq-answer">
<p>
<strong>Yes, comprehensive private transportation is included with
                    every itinerary.</strong>
...
<span className="faq-question-text">Can I book hotels separately?</span>
</div>
<div aria-hidden="true" className="faq-icon-toggle">
<svg fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" viewBox="0 0 24 24" width="18">
<polyline points="6 9 12 15 18 9"></polyline>
...
<div className="faq-answer">
<p>
<strong>Yes, we provide standalone hotel and resort booking
                    services</strong>
...
<div className="faq-answer">
<p>
<strong>Yes, we offer multiple secure digital and online payment
                    channels.</strong>
                  You can pay easily via:
                </p>
<ul style={{'margin': '0.5rem 0 0.75rem 1.25rem', 'lineHeight': '1.8'}}>
<li>
...
<p>
                  As an empanelled and GST-registered agency (<strong>GSTIN: 16DTDPS0586Q2ZU</strong>), every transaction receives an immediate digital payment
                  receipt followed by a formal tax invoice suitable for
                  personal, corporate, or government LTC reimbursement claims.
                </p>
</div>
</details>
...
<span className="faq-question-text">Do you organize group tours?</span>
</div>
<div aria-hidden="true" className="faq-icon-toggle">
<svg fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" viewBox="0 0 24 24" width="18">
<polyline points="6 9 12 15 18 9"></polyline>
...
<div className="faq-answer">
<p>
<strong>Yes, we have extensive experience managing custom group
                    departures</strong>
...
<span className="faq-question-text">Do you provide honeymoon packages?</span>
</div>
<div aria-hidden="true" className="faq-icon-toggle">
<svg fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" viewBox="0 0 24 24" width="18">
<polyline points="6 9 12 15 18 9"></polyline>
...
<div className="faq-answer">
<p>
<strong>Yes, bespoke romantic honeymoons are one of our signature
                    specialties.</strong>
                  We craft private honeymoon itineraries to dream destinations
                  like
                  <em>Kashmir (Pahalgam &amp; Gulmarg), Meghalaya (Cherrapunji &amp;
                    Dawki glamping), Sikkim &amp; Darjeeling, Andaman Islands
                    (Havelock beach villas), Kerala Backwaters, Rajasthan
                    Palaces, Bali, Thailand, and the Maldives</em>.
                </p>
<p>
